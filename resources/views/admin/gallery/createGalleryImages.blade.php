                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Gallery {{$gallery->name}} images Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="POST" action="{{url('getGalleryImage')}}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="hidden" name="gallery_id" value="{{empty($gallery->id) ? old('gallery_id') : $gallery->id }}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-sm-10">
                                            ...
                                            <small class="form-text text-muted">
                                                Only PNG, JPEG, JPG are allowed.</small><br/>
                                            <small class="form-text text-muted">
                                                Max 4MB size. Max dimension 3000x2000.</small>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
